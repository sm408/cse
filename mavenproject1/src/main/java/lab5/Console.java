...
class FlightSimple implements Game {
    ...
    public FlightSimple(int keystrokes) {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (ch == '1') {
                ...
                FlightSimple game = new FlightSimple(keystrokes);
                ...
                game.IsOver();
                System.out.println("Press any key to move ahead.");
                char wait = input.next().charAt(0);
            } else if (ch == '2') {
                System.out.println("Enter The Number of Moves you Have:");
                int keystrokes = input.nextInt();
                RandomWalk game = new RandomWalk(keystrokes);
